...
export async function seedDatabase() {
  ...
  await storage.createExercise({ bookId: book1.id, title: "Habit Scorecard", description: "Create awareness of your daily habits by scoring each one. List your daily habits and mark them as positive (+), negative (-), or neutral (=).", type: "reflection", content: { prompt: "Write down your complete daily routine from waking up to going to bed. Next to each habit, write +, -, or = to rate whether it's positive, negative, or neutral for the person you want to become." }, orderIndex: 1 });
  ...
  await storage.createStory({ bookId: book2.id, title: "The Invisible Gorilla", content: "In a famous experiment by Christopher Chabris and Daniel Simons, participants were asked to watch a video of people passing basketballs and count the number of passes made by the team wearing white. While focused on counting, about half the participants completely failed to notice a person in a gorilla suit walking through the scene, stopping to beat their chest, and walking off. The experiment demonstrated how focused attention on one task can create 'inattentional blindness' to other obvious events.", moral: "Our System 1 creates a coherent story from limited information. When we focus intensely on one thing, we can be blind to what is literally right in front of us.", orderIndex: 1 });
  await storage.createStory({ bookId: book2.id, title: "The Halo Effect in Action", content: "Kahneman describes grading student essays. When he graded them sequentially (all questions for one student, then the next), his impression of the first essay influenced his judgment of later essays. A brilliant first answer created a 'halo' that made subsequent mediocre answers seem better than they were. He changed his method to grade all students' answers to question 1 before moving to question 2.", moral: "First impressions create a halo that colors all subsequent judgments. To make better decisions, evaluate each piece of evidence independently.", orderIndex: 2 });

  // --- Thinking, Fast and Slow Exercises ---
  await storage.createExercise({ bookId: book2.id, title: "Spot Your System 1 Biases", description: "Reflect on recent decisions where your fast-thinking System 1 may have led you astray.", type: "reflection", content: { prompt: "Think about the last important decision you made quickly (within minutes). What assumptions did your 'gut feeling' make? Looking back, what information did you overlook? How might the outcome have been different if you had slowed down and engaged System 2?" }, orderIndex: 1 });
  ...
  await storage.createPrinciple({ bookId: book3.id, title: "The Present Moment Is All You Have", content: "Nothing has happened in the past; it happened in the Now. Nothing will ever happen in the future; it will happen in the Now. The present moment is the only thing you ever have. Make the Now the primary focus of your life.", orderIndex: 1, icon: "circle" });
  await storage.createPrinciple({ bookId: book3.id, title: "You Are Not Your Mind", content: "The beginning of freedom is the realization that you are not the possessing entity — the thinker. The moment you start watching the thinker, a higher level of consciousness becomes activated. You begin to realize there is a vast realm of intelligence beyond thought.", orderIndex: 2, icon: "eye" });
  await storage.createPrinciple({ bookId: book3.id, title: "The Pain-Body", content: "The pain-body is a semi-autonomous energy form that lives within most human beings. It is the accumulated emotional pain from the past. It can be dormant or active. When triggered, it takes you over, creating suffering and negative reactions.", orderIndex: 3, icon: "heart" });

  // --- The Power of Now Stories ---
  await storage.createStory({ bookId: book3.id, title: "The Beggar on the Box", content: "Tolle tells the story of a beggar who sat on a box at the side of the road for years. One day a passerby asked what was in the box. 'Nothing,' said the beggar. 'I've never looked.' The passerby insisted he look. The beggar pried open the lid and discovered the box was filled with gold. Tolle explains that this box is a metaphor — we spend our lives begging for something, not realizing that the treasure of peace and fulfillment is already within us, in the present moment.", moral: "Stop looking outside yourself for fulfillment. Everything you need is already within you, accessible through present-moment awareness.", orderIndex: 1 });
  ...
  await storage.createExercise({ bookId: book3.id, title: "Watching the Thinker", description: "Practice observing your thoughts without attachment.", type: "reflection", content: { prompt: "Set a timer for 5 minutes. Sit quietly and observe the stream of thoughts that passes through your mind. Don't judge, engage with, or try to stop any thoughts. Simply watch them like clouds passing across the sky. After the exercise, write about what you noticed. Were there recurring themes? How did it feel to observe rather than participate?" }, orderIndex: 2 });

  // --- Emotional Intelligence Principles ---
  await storage.createPrinciple({ bookId: book4.id, title: "Self-Awareness Is the Foundation", content: "Emotional intelligence begins with self-awareness — the ability to recognize and understand your own emotions as they occur. People with high self-awareness understand their strengths, weaknesses, values, and motivations, and how their feelings affect their behavior and performance.", orderIndex: 1, icon: "mirror" });
  await storage.createPrinciple({ bookId: book4.id, title: "Emotional Hijacking", content: "The amygdala can trigger an emotional response before the rational brain has time to process the situation. This 'amygdala hijack' explains why we sometimes say or do things in anger that we later regret. Learning to pause before reacting is key.", orderIndex: 2, icon: "zap" });
  await storage.createPrinciple({ bookId: book4.id, title: "Empathy Drives Connection", content: "Empathy — the ability to sense other people's emotions and imagine what they might be thinking or feeling — is the most important people skill. It is built on self-awareness; the more open we are to our own emotions, the more skilled we become at reading others.", orderIndex: 3, icon: "users" });

  // --- Emotional Intelligence Exercises ---
  await storage.createExercise({ bookId: book4.id, title: "Emotion Log", description: "Track your emotions throughout the day to build self-awareness.", type: "reflection", content: { prompt: "For the next 24 hours, pause three times (morning, afternoon, evening) and ask yourself: What am I feeling right now? What triggered this feeling? How is this emotion affecting my behavior? Write your observations here." }, orderIndex: 1 });
  ...
  await storage.createPrinciple({ bookId: book5.id, title: "The Last Human Freedom", content: "Everything can be taken from a man but one thing: the last of the human freedoms — to choose one's attitude in any given set of circumstances, to choose one's own way. Between stimulus and response there is a space, and in that space lies our freedom.", orderIndex: 1, icon: "key" });
  await storage.createPrinciple({ bookId: book5.id, title: "Meaning Through Suffering", content: "If there is meaning in life at all, then there must be meaning in suffering. Suffering is an ineradicable part of life. Without suffering and death, human life cannot be complete. The way in which a person takes up their cross gives them ample opportunity to add a deeper meaning to life.", orderIndex: 2, icon: "mountain" });
  await storage.createPrinciple({ bookId: book5.id, title: "Logotherapy: The Will to Meaning", content: "Frankl's therapeutic approach, logotherapy, is based on the premise that the primary motivational force of an individual is to find meaning in life. It focuses on the meaning of human existence and on the search for such meaning, rather than on pleasure or power.", orderIndex: 3, icon: "compass" });

  // --- Man's Search for Meaning Stories ---
  await storage.createStory({ bookId: book5.id, title: "The Imagined Lecture", content: "During his time in the concentration camps, Frankl kept himself going by imagining himself giving a lecture after the war about the psychology of the concentration camp. He would mentally compose entire speeches, detailing his observations about human behavior under extreme duress. This mental exercise gave him a sense of purpose — transforming his suffering into a subject for future teaching. By finding meaning in his pain, he found the strength to endure.", moral: "When you find a 'why' to live for, you can endure almost any 'how.' Projecting purpose into the future can sustain you through present suffering.", orderIndex: 1 });

  // --- Man's Search for Meaning Exercises ---
  await storage.createExercise({ bookId: book5.id, title: "Finding Your 'Why'", description: "Reflect on what gives your life meaning and purpose.", type: "reflection", content: { prompt: "Frankl believed there are three sources of meaning: (1) creating a work or doing a deed, (2) experiencing something or encountering someone, and (3) the attitude we take toward unavoidable suffering. Reflect on your life through these three lenses. What work fulfills you? Who or what brings you deep joy? How have you grown from a difficult experience?" }, orderIndex: 1 });
