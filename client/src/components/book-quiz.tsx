...
export function BookQuiz({ bookId, bookTitle, onClose, onCelebrate }: BookQuizProps) {
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6" data-testid="quiz-results">
        <motion.div
        ...
        >
          ...
          <Card className="p-4 mb-6 bg-black border-primary/10">
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col" data-testid="book-quiz">
